        ...
        .auth
          ...
          .auth__form
            ...
            form(@submit.prevent="onSubmit")
              .form-input(:class="{ errorInput: $v.email.$error }")
                input(
                  type = "email"
                  placeholder = "Email"
                  v-model = "email"
                ...
                .form-input(:class="{ errorInput: $v.password.$error }")
                input(
                  type = "password"
                ...
                .form-input(:class="{ errorInput: $v.repeatPassword.$error }")
                input(
                  type = "password"
